...
export const directories = [
  `${homedir}/.nolaniumwallet`,
  `${homedir}/.nolaniumwallet/logs`
];
...
remote.app.setAppUserModelId('wallet.nolanium');

log.debug(`Nolanium Wallet started...`);
  ...
  const message = (
    <div>
      ...
      <p className={`subtitle ${textColor}`}>
        There&apos;s a new version of Nolanium Wallet available. Would you like to
        download it?
      </p>
    </div>
  );
...
function handleHelp() {
  remote.shell.openExternal('https://discord.gg/VqsQntFK');
}
